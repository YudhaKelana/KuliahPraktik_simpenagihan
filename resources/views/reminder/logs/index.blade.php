<x-layouts.app :title="'Log Pesan Email'">
    <h1 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Log Pesan Email</h1>
    <form method="GET" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-6 shadow-sm flex flex-wrap gap-3">
        ...
        @endif
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari email/nomor HP..." class="rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm px-3 py-2 flex-1 min-w-[150px] dark:text-white">
        ...
        <table class="w-full text-sm" data-sortable>
            <thead class="bg-gray-50 dark:bg-gray-700/50 text-xs text-gray-500 uppercase">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left" data-sort>Pesan</th>
                    <th class="px-4 py-3 text-center" data-sort>Status</th>
                    <th class="px-4 py-3 text-center" data-sort>Retry</th>
                    <th class="px-4 py-3 text-left" data-sort>Error</th>
