<x-layouts.app :title="'Kontak Wajib Pajak'">
    ...
    <form method="GET" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-6 shadow-sm flex flex-wrap gap-3">
        ...
        @endif
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama/NIK/HP/email..." class="rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm px-3 py-2 flex-1 min-w-[200px] dark:text-white">
        ...
        <table class="w-full text-sm" data-sortable>
            <thead class="bg-gray-50 dark:bg-gray-700/50 text-xs text-gray-500 dark:text-gray-400 uppercase">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left" data-sort>HP</th>
                    <th class="px-4 py-3 text-left" data-sort>Email</th>
                    <th class="px-4 py-3 text-center" data-sort>Kendaraan</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                @empty
                <tr><td colspan="7" class="px-4 py-12 text-center text-gray-400">Belum ada data</td></tr>
                @endforelse
            </tbody>
        </table>
    </x-data-table>
