<x-layouts.app :title="'Tunggakan'">
    ...
    <x-data-table :paginator="$arrears">
        <table class="w-full text-sm" data-sortable>
            <thead class="bg-gray-50 dark:bg-gray-700/50 text-xs text-gray-500 dark:text-gray-400 uppercase">
                <tr>
                    ...
                    <th class="px-4 py-3 text-right" data-sort>Tunggakan</th>
                    <th class="px-4 py-3 text-center" data-sort>Tahun</th>
                    <th class="px-4 py-3 text-center">Flags</th>
                    <th class="px-4 py-3 text-center" data-sort>Tgl Kalkulasi</th>
                </tr>
            </thead>
